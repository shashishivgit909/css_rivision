...
=> inline-block : These elements like button streches in flex to take full availibale width if its width not restricted or given flex-grow:0 or wrap it in block element like div.q
